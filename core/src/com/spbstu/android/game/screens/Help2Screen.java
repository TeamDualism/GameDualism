...
public class Help2Screen extends ScreenAdapter {
    ...
    public Help2Screen(final GameDualism game) {
        this.game = game;
        ...
        Image image = new Image(new Texture("help2.png"));
        ...
        rightButton.setBounds(WIDTH / 2f + maxButtonsSize / 3f, maxButtonsSize  / 6, maxButtonsSize * 2 / 3, maxButtonsSize * 2 / 3);
        rightButton.setVisible(true);
        rightButton.addListener(new ClickListener(Input.Buttons.LEFT) {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                screenProcesser.setHelp3Screen();
                GameDualism.playSound(buttonEffect);
            }
        });
